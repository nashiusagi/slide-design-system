...
import { COMPONENTS_PAGE_ID, FOUNDATIONS_PAGE_ID, LAYOUTS_PAGE_ID, RULES_PAGE_ID } from './page-ids'
 ...
 *
 * ページを足すときの id は hash の許容書式（英小文字・数字・ハイフン）に収め、数字だけの
 * 名前は使わない（src/docs/hash.ts）。
 *
