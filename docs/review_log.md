...
最終更新: 2026-09-20（PR #52 レビュー 3周目）
...
| `contract/contract-structure-duplicated` | 正本の中身の一覧が、別の文書へ構造ごと複製された | 7 | PR #52 | 未着手 |
...
| `decisions/undocumented-decision` | 決定記録 | DR に無い判断が、PR説明やIssueにだけ書かれている | 12 | PR #13 | PR #52 |
...
| `writing/contradictory-instruction` | 日本語 | 同じ状況に対する指示が文書間で食い違う | 6 | PR #17 | PR #52 |
...
| `inspection/rule-coverage-partial` | 検査 | 判定対象の列挙に穴があり、基準を割った組み合わせを見逃す | 7 | PR #20 | PR #52 |
| `inspection/invalid-case-untested` | 検査 | 検査そのものに invalid ケースのテストが無い | 3 | PR #20 | PR #52 |
...
| `writing/test-title-ambiguous` | 日本語 | テストタイトルが、そのテストの固定する不変条件を示していない | 6 | PR #23 | PR #52 |
...
| `decisions/wrong-dr-citation` | 決定記録 | 誤った DR 番号を根拠として引用している | 2 | PR #24 | PR #52 |
...
| `writing/inaccurate-rationale` | 日本語 | 説明文が書いている理由付けが、実装の挙動と食い違う | 11 | PR #23 | PR #52 |
...
| `inspection/bundle-boundary-unchecked` | 検査 | 分離すると決めたビルドエントリ間の参照境界を保証する検査が無い | 1 | PR #40 | PR #40 |
...
| `decisions/one-sided-coupling` | 決定記録 | DR 間の連動が片方の DR にしか書かれておらず、逆向きに辿れない | 2 | PR #51 | PR #52 |
...
|---|---|---|---|---|---|
| #52 | 2026-09-20 | 0 | 20 | 15 | [pr-52.md](./reviews/pr-52.md) |
