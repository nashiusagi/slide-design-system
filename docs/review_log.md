...
最終更新: 2026-09-24（PR #61 レビュー 5周目）
...
| `writing/term-inconsistency` | 同じものが複数の呼び名を持ち、外延も揺れる | 16 | PR #61 | 未着手 |
...
| `writing/term-inconsistency` | 日本語 | 同じものが複数の呼び名を持ち、外延も揺れる | 16 | PR #13 | PR #61 |
