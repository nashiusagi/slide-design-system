...
最終更新: 2026-09-12（PR #51 レビュー 3周目・収束）
...
| `inspection/rule-coverage-partial` | 検査 | 判定対象の列挙に穴があり、基準を割った組み合わせを見逃す | 6 | PR #20 | PR #47 |
...
| `writing/test-title-ambiguous` | 日本語 | テストタイトルが、そのテストの固定する不変条件を示していない | 5 | PR #23 | PR #47 |
...
| `decisions/one-sided-coupling` | 決定記録 | DR 間の連動が片方の DR にしか書かれておらず、逆向きに辿れない | 1 | PR #51 | PR #51 |
